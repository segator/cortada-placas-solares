...
# ── Cost and Energy Distribution ─────────────────────────────
# 41% Comunitaria (común) / 59% Privativa (privado)
# Applied to BOTH total cost and total energy independently

COMMON_COST_TOTAL = TOTAL_COST_IVA * COMMON_ENERGY_RATIO      # 41% × 41,439 = 16,990 EUR
